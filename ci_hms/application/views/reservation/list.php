	...
	<div class="main-inner">
		<div class="container">
			...
			<div class="add-fields">
				 ...
				 <div class="field">
          <label for="customer_TCno">NIK:</label>
          <input type="text" id="nik" name="nik" required value="" placeholder="nik"/>
        </div> <!-- /field -->
		<div class="field">
          <label for="customer_TCno">Nama</label>
          <input type="text" id="nama" name="nama" required value="" placeholder="Nama"/>
        </div> <!-- /field -->
				<div class="field">
					...
					<table class="table table-striped table-bordered">
						...
						<?php for ($t=0, $i=0; $t<$rows; ++$t) { ?>
							<tr>
								...
								<td class="td-actions"><button name="room_id" value="<?=$rooms[$i]->room_id?>" onclick="return confirm('Reservasi Sukses')" class="btn btn-small btn-primary"><?=$rooms[$i]->room_id?><br><i class="btn-icon-only icon-edit"> </i></button></td>
							<?php } ?>
							</tr>
						<?php } ?>
						</tbody>
